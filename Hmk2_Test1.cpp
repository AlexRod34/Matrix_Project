...
Description:
This file tests the ECE_matrix class using its constructors and overloaded operators
*/
...
int main() 
{
   ...
   //std::cout << "M4: " << std::endl << M4 << std::endl;
    ...
    //std::cout << "M3: not modified" << std::endl << M3 << std::endl;

    std::cout << "M9: (M1 * 8.0) " << std::endl << M9 << std::endl;
    std::cout << "M10: (M1 / 8.0) " << std::endl << M10 << std::endl;
    std::cout << "M11 += M1:" << std::endl << M11 << std::endl;
    std::cout << "M12 -= M1" << std::endl << M12 << std::endl;
